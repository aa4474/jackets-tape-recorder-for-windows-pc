...
* **Auto-Cassette noise:** Just like the real Jacket, the program automatically plays a random tape recorder "noise" immediately before and after your chosen voice line which make it just like in payday 2.
* **Dual Menus:**
...
## 🎙️ How to Play Sounds in Voice Chat 

If you want the game VC to hear Jacket instead of your real voice, you need to route the application's audio into your microphone input.
